...
%%%%%%%%% TITLE
\title{A Survey on Online Knowledge Distillation Methods}
...
Online methods are developed to address these problems. Online distillation is single-stage training process. Normally it starts from a random ensumble teacher network and
updates this network during the distillation process. Online methods outperforms 
